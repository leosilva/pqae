...
//		def an2 = new AnalyzedSystem(systemName : "System A", previousVersion : "3.0", nextVersion : "4.0", analyzedSystemStatus: AnalyzedSystemStatus.COMPLETED)
//		//def an3 = new AnalyzedSystem(systemName : "System A", previousVersion : "4.0", nextVersion : "5.0", analyzedSystemStatus: AnalyzedSystemStatus.COMPLETED)
...
//		def an7 = new AnalyzedSystem(systemName : "System B", previousVersion : "4.0", nextVersion : "5.0", analyzedSystemStatus: AnalyzedSystemStatus.COMPLETED)
...
//		def an9 = new AnalyzedSystem(systemName : "System B", previousVersion : "6.0", nextVersion : "7.0", analyzedSystemStatus: AnalyzedSystemStatus.COMPLETED)
//		ans += an
//		ans += an1
//		ans += an2
		//ans += an3
