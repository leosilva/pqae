...
joint.shapes.uml.Class = joint.shapes.basic.Generic.extend({
    ...
    updateRectangles: function() {
        ...
        // esta linha foi adicionada para redimensionar corretamente a altura do box
        this.get("size").height=offsetY * 60/100;
        this.get("size").width=longestLine;
    }
...
joint.shapes.uml.Enum = joint.shapes.uml.Class.extend({
...
joint.shapes.uml.EnumView = joint.shapes.uml.ClassView;
